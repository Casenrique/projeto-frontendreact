...
var SekindoClientDetections_URL = function (config) {
	...
	if (this.isPlayerApiActions && !this.isAmpProject && !this.isAmpIframe && !this.isApp) this.playerApiActions();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.primis.tech/live/liveView.php?s=111724&subId=[PL-Reg-Org]&cbuster=1668647688',
					origQString: 's=111724&subId=[PL-Reg-Org]',
					placementId: 111724,
					x: 600,
					y: 338,
					videoType: 'flow',
					...
					isAPI: false,
					debug: 0,
					ci: {"extra":{"schemaVer":"11","os":"Windows","osVersion":"10.0","osVersionMajor":"10","osVersionMinor":"0","deviceManufacturer":"","deviceModel":"","deviceCodeName":"","deviceType":"desktop","browser":"Chrome","browserType":"browser","browserVersion":"107.0.0.0","browserVersionMajor":"107","browserVersionMinor":"0","chromeVersion":"107"},"browser":"chrome","os":"windows","osVer":"","deviceType":"desktop","languages":{"0":"pt","2":"en"},"googlePSI":false},
					isFpCookie: 0,
					geo: 'BR',
					dmaCode: 0,
					dynamicSetup: [],
					...
					customTargetingProperties: {"objectType":"window.top","objectFunction":"au_seg.segments"},
